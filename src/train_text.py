...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', default='../model_storage/text_seed2023_adda_addmergeA_3407_all', type=str, help="训练模型保存地址")
    ...
    # 5, 20, last  num
    # 5, 1000, 2000 all
    parser.add_argument('--num_train_epochs', default=8, type=int, help="训练epoch数")
    parser.add_argument('--eval_steps', default=250, type=int, help="模型评估间隔数")
    parser.add_argument('--save_steps', default=250, type=int, help="模型保存间隔步数")
