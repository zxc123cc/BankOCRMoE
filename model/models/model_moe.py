...
class BankOCRMoE(PreTrainedModel):
    ...
    def __init__(
        ...
        self.gate_classifier = GateClassificationHead(config.encoder.hidden_size, config.encoder.hidden_dropout_prob,
                                                      num_experts)
    ...
    def load_moe_encoder_decoder_from_vision_pretrain(self, pretrain_path):
        ...
        self.decoders = nn.ModuleList(
            [VisionEncoderDecoderModel.from_pretrained(pretrain_path).get_decoder() for _ in range(self.num_experts)])
